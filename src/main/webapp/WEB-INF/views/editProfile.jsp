...
<form id="formEdit" method="post" action="editProfile">
	...
	<br><div class="form-row"><label>Username</label> <input type="text" readonly="readonly" style="position: absolute; left: 140px;" type="text" value = "${user.username}" required name="username"></div>
